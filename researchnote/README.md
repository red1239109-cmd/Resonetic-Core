...
Instead, it explores how tension, contradiction, and uncertainty can be measured, classified, and transformed into creative energy inside computational systems.

This repository contains three evolutionary versions of the same idea, developed sequentially as understanding deepened.
...
measures its structure

decides whether it should be fed, ignored, or collapsed

Repository Structure (3 Versions)
...
Measure code quality as a living structure, not style compliance.
...
Each paradox is evaluated across dimensions:
...
Type	Meaning	Action
creative_tension	Stable contradiction that generates insight	PRESERVE_AND_FEED
...
This is not opinion-based — it is rule-based, auditable, and reproducible.
...
Instead of asking “What should AI become?”
we ask “What should be removed?”

License

AGPL-3.0
Dual-license possible for commercial use.
See headers in individual files.
