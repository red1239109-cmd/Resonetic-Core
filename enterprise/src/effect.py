...
class ActionEffectAnalyzer:
    def __init__(self, timeline, window_steps: int = 10):
    ...
    def collect(self, action_id: str, metrics: Dict[str, float]):
        ...
        self.buffers[action_id]["samples"].append(dict(metrics or {}))
    ...
    def finalize(self, action_id: str, step: int) -> Optional[Dict[str, Any]]:
        ...
        # Verdict Logic: Risk down (-), Loss down (-), Stability up (+) is GOOD
        score = 0.0
