...
class ResoneticsEngine:
    ...
    def _compute_risk_and_verdict(self, entropy_gradient: float, pop_volatility: int, emergency_ratio: float):
        rconf = CONFIG["risk"]
    ...
    def log_to_buffer(self, avg_energy, total_entropy):
        ...
        # PATCH 4-2: risk & verdict 계산
        risk, verdict = self._compute_risk_and_verdict(
            entropy_gradient,
...
def run_simulation():
    ...
    print("🌱 [Resonetics v3.3.2 + Risk/Verdict Patch] Simulation Started...")
